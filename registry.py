...
class ClientThread(threading.Thread):
    ...
    def run(self):
        ...
        # logging.info("Connection from: " + self.ip + ":" + str(self.port))
        logging.info("Connection from: " + self.ip + ":" + str(self.port) + " at time of " + str(timestamp))        
        print("IP Connected: " + self.ip + ":" + str(self.port))
        ...
        while True:
            try:
                ...
                #   LOGIN    #
                    ...
                    print("Joining room" + message[1])
                    if db.is_user_in_room_exist(message[1], message[2]):
                    ...
                    # if an account with this username is not exist, and the account is created
                        ...
                        db.join_room(message[1], message[2])
                        response = "join_room-success"
                        logging.info(
                            "Send to "
                            + self.ip
                            + ":"
                    ...
                    # if an account with the username exists and not online
                        ...
                        if retrievedPass == message[2]:
                            ...
                            db.user_login(message[1], message[3], message[4])
                            # login-success is sent to peer,
                ...
                timestamp = datetime.now().strftime("%Y-%m-%d %H:%M:%S")
                logging.error(timestamp + " OSError: {0}".format(oErr))                
